...
var _user$project$Main$dictValues = function (dec) {
	return A2(
		_elm_lang$core$Json_Decode$map,
		_elm_lang$core$Dict$values,
		_elm_lang$core$Json_Decode$dict(dec));
};
var _user$project$Main$decodeJson = A2(_elm_lang$core$Json_Decode_ops[':='], 'value', _elm_lang$core$Json_Decode$string);
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$nodeBaseUrl = function (entity) {
	var _p0 = _elm_lang$core$String$uncons(entity.address);
	if (_p0.ctor === 'Nothing') {
		return '/';
	} else {
		return A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(entity.puerto),
						'/'))));
	}
};
var _user$project$Main$apiUrl = function (entity) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Main$nodeBaseUrl(entity),
		'swagger-ui');
};
var _user$project$Main$toUrl = function (entity) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#https://localhost:',
		_elm_lang$core$Basics$toString(entity.puerto));
};
var _user$project$Main$entityLink = function (entity) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Main$toUrl(entity))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(entity.id)
					]))
			]));
};
var _user$project$Main$entitiesUl = function (entities) {
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _user$project$Main$entityLink, entities));
};
var _user$project$Main$healthView = function (health) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(health.entity.id)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href(
								_user$project$Main$apiUrl(health.entity))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('slaves')
					])),
				_user$project$Main$entitiesUl(health.slaves),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
					[]),
				...
				_user$project$Main$entitiesUl(health.devices)
			]));
};
				...
				[
					...
					if (_p1.ctor === 'Nothing') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Nothing yet')
								]));
					} else {
						return _user$project$Main$healthView(_p1._0);
					}
				}(),
					A2(
					_elm_lang$html$Html$h3,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(model.healthJson)
						]))
				]),
			function () {
				var _p2 = model.error;
...
var _user$project$Main$Route = F2(
	function (a, b) {
		return {nodeAddress: a, viewType: b};
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {route: a, health: b, healthJson: c, error: d, loading: e};
	});
var _user$project$Main$Entity = F4(
	function (a, b, c, d) {
		return {id: a, kind: b, address: c, puerto: d};
	});
var _user$project$Main$decodeEntity = A5(
...
var _user$project$Main$Health = F3(
	function (a, b, c) {
		return {entity: a, slaves: b, devices: c};
	});
var _user$project$Main$decodeHealth = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Main$Health,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Entity', _user$project$Main$decodeEntity),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'Slaves',
		_user$project$Main$dictValues(_user$project$Main$decodeEntity)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'Devices',
		_user$project$Main$dictValues(_user$project$Main$decodeEntity)));
			...
			case 'FetchSucceed':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							healthJson: _p4,
							health: _elm_lang$core$Result$toMaybe(
								A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodeHealth, _p4)),
							loading: false
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$Main$JsonView = {ctor: 'JsonView'};
...
var _user$project$Main$getHealth = function (nodeAddress) {
	var url = A2(_elm_lang$core$Basics_ops['++'], nodeAddress, '/v1/health');
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$FetchFail,
		_user$project$Main$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Main$decodeJson, url));
};
var _user$project$Main$urlUpdate = F2(
	function (route, model) {
		return {
			...
			_1: _user$project$Main$getHealth(route.nodeAddress)
		};
	});
var _user$project$Main$init = function (route) {
	return A2(
		_user$project$Main$urlUpdate,
		route,
		A5(_user$project$Main$Model, route, _elm_lang$core$Maybe$Nothing, 'nothing yet', _elm_lang$core$Maybe$Nothing, false));
};
...
var _user$project$Main$UpdateRoute = function (a) {
